...
data work.xmr_fed;
    infile "/home/u64447590/XMR/Monero_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot XMR vs FED Funds */
title "Monero (XMR) Price and FED Funds Rate Comparison";
proc sgplot data=work.xmr_fed;
    ...
    keylegend "xmr_line" "fed_line" / position=topright;
run;
title;