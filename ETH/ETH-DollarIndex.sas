/* STEP 1: Define ETH File Path */
%let file_path = /home/u64447590/ETH/eth_ready.csv;
...
/* STEP 3: Plot ETH vs DXY */
title "Ethereum (ETH) Price and Dollar Index (DXY) Comparison";
proc sgplot data=work.eth_data;
    ...
    keylegend "eth_line" "dxy_line" / position=topright;
run;
title;