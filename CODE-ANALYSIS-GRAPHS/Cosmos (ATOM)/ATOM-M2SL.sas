...
/* STEP 2: Plot ATOM vs M2 */
title "Cosmos (ATOM) Price and M2 Money Supply Comparison";
proc sgplot data=work.atom_m2;
    ...
    keylegend "atom_line" "m2_line" / position=topright;
run;
title;