...
data work.atom_fed;
    infile "/home/u64447590/ATOM/Cosmos_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot ATOM vs FED Funds */
title "Cosmos (ATOM) Price and FED Funds Rate Comparison";
proc sgplot data=work.atom_fed;
    ...
    keylegend "atom_line" "fed_line" / position=topright;
run;
title;