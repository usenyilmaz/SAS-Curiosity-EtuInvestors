...
data work.ada_fed;
    infile "/home/u64447590/ADA/Cardano_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot ADA vs FED Funds */
title "Cardano (ADA) Price and FED Funds Rate Comparison";
proc sgplot data=work.ada_fed;
    ...
    keylegend "ada_line" "fed_line" / position=topright;
run;
title;