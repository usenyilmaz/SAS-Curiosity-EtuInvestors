...
data work.eos_fed;
    infile "/home/u64447590/EOS/EOS_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot EOS vs FED Funds */
title "EOS Price and FED Funds Rate Comparison";
proc sgplot data=work.eos_fed;
    ...
    keylegend "eos_line" "fed_line" / position=topright;
run;
title;