...
data work.cro_fed;
    infile "/home/u64447590/CRO/Cronos_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot CRO vs FED Funds */
title "Cronos (CRO) Price and FED Funds Rate Comparison";
proc sgplot data=work.cro_fed;
    ...
    keylegend "cro_line" "fed_line" / position=topright;
run;
title;