/* STEP 1: Define DOGE File Path */
%let file_path = /home/u64447590/DOGE/Dogecoin_ready.csv;
...
/* STEP 3: Plot DOGE vs DXY */
title "Dogecoin (DOGE) Price and Dollar Index (DXY) Comparison";
proc sgplot data=work.doge_data;
    /* Primary Y-Axis: DOGE Price (Logarithmic) */
    ...
    keylegend "doge_line" "dxy_line" / position=topright;
run;
title;