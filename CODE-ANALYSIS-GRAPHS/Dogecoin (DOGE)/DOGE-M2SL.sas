...
/* STEP 2: Plot DOGE vs M2 */
title "Dogecoin (DOGE) Price and M2 Money Supply Comparison";
proc sgplot data=work.doge_m2;
    ...
    keylegend "doge_line" "m2_line" / position=topright;
run;
title;