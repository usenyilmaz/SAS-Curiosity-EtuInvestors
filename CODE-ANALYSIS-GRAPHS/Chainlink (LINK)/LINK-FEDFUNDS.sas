...
data work.link_fed;
    infile "/home/u64447590/LINK/Chainlink_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot LINK vs FED Funds */
title "Chainlink (LINK) Price and FED Funds Rate Comparison";
proc sgplot data=work.link_fed;
    ...
    keylegend "link_line" "fed_line" / position=topright;
run;
title;