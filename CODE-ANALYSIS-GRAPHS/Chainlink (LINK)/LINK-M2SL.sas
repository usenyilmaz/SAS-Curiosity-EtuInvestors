...
/* STEP 2: Plot LINK vs M2 */
title "Chainlink (LINK) Price and M2 Money Supply Comparison";
proc sgplot data=work.link_m2;
    ...
    keylegend "link_line" "m2_line" / position=topright;
run;
title;