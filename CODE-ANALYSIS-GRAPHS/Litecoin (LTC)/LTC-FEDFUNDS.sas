...
/* STEP 2: Plot LTC vs FED Funds */
title "Litecoin (LTC) Price and FED Funds Rate Comparison";
proc sgplot data=work.ltc_fed;
    ...
    keylegend "ltc_line" "fed_line" / position=topright;
run;
title;