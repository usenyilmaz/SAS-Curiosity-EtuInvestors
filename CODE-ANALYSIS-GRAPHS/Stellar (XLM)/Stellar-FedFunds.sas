...
data work.xlm_fed;
    infile "/home/u64447590/Stellar/Stellar_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot XLM vs FED Funds */
title "Stellar (XLM) Price and FED Funds Rate Comparison";
proc sgplot data=work.xlm_fed;
    ...
    keylegend "xlm_line" "fed_line" / position=topright;
run;
title;