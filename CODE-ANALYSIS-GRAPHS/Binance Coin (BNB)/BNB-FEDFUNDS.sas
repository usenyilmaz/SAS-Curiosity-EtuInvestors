...
data work.bnb_fed;
    infile "/home/u64447590/BNB/BinanceCoin_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot BNB vs FED Funds */
title "Binance Coin (BNB) Price and FED Funds Rate Comparison";
proc sgplot data=work.bnb_fed;
    ...
    keylegend "bnb_line" "fed_line" / position=topright;
run;
title;