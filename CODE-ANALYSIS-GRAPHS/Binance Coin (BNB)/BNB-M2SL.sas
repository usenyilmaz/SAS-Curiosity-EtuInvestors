...
/* STEP 2: Plot BNB vs M2 */
title "Binance Coin (BNB) Price and M2 Money Supply Comparison";
proc sgplot data=work.bnb_m2;
    ...
    keylegend "bnb_line" "m2_line" / position=topright;
run;
title;