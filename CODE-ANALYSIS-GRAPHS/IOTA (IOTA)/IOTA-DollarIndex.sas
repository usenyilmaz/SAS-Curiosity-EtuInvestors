/* STEP 1: Define IOTA File Path */
%let file_path = /home/u64447590/IOTA/IOTA_ready.csv;
...
/* STEP 3: Plot IOTA vs DXY */
title "IOTA Price and Dollar Index (DXY) Comparison";
proc sgplot data=work.iota_data;
    /* Primary Y-Axis: IOTA Price (Logarithmic) */
    ...
    keylegend "iota_line" "dxy_line" / position=topright;
run;
title;