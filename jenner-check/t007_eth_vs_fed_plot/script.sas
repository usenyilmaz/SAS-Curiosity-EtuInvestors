/* Adapted from CODE-ANALYSIS-GRAPHS/CryptoCoins/Ethereum (ETH)/ETH-FEDFUNDS.sas
   Only edit: hardcoded /home/u64447590/ETH/eth_ready.csv path rewritten to
   ./input/eth_ready.csv. */

/* STEP 1: Data Processing (Reading FEDFUNDS) */
data work.eth_fed;
    infile "./input/eth_ready.csv" dlm=';' firstobs=2 dsd;
...
/* STEP 2: Plot ETH vs FED Funds */
title "Ethereum (ETH) Price and FED Funds Rate Comparison";
proc sgplot data=work.eth_fed;
    ...
    keylegend "eth_line" "fed_line" / position=topright;
run;
title;

proc print data=work.eth_fed(obs=10); run;
