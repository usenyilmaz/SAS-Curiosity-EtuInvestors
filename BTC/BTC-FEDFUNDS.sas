...
data work.btc_fed;
    infile "/home/u64447590/BTC/btc_ready.csv" dlm=';' firstobs=2 dsd;
    ...
    format Date_sas date9. Price_num Fed_num 12.2;
    keep Date_sas Price_num Fed_num;
run;

/* STEP 2: Plot BTC vs FED Funds */
title "Bitcoin (BTC) Price and FED Funds Rate Comparison";
proc sgplot data=work.btc_fed;
    ...
    keylegend "btc_line" "fed_line" / position=topright;
run;
title;